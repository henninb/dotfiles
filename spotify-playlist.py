...
def populate_playlist(args, playlist_id, song_list):
    ...
    for song in song_list1:
        ...
        result = requests.get(url=search_URL, params=search_parms, headers=req_Headers)
        ...
        print(track_name)
        print(track_uri)
        add_track_result = requests.post(url=add_tracks_URL, params=track_parms, headers=req_Headers)
