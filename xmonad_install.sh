...
if [ \( "$OS" = "Linux Mint" \) -o \(  "$OS" = "Ubuntu" \) -o \(  "$OS" = "Raspbian GNU/Linux" \) ]; then
  ...
  sudo apt install -y xmonad xmobar libghc-xmonad-contrib-dev libghc-xmonad-contrib-doc libghc-xmonad-contrib-prof libghc-xmonad-dev  libghc-xmonad-doc libghc-xmonad-extras-dev libghc-xmonad-extras-prof libghc-xmonad-prof libghc-xmonad-wallpaper-dev libghc-xmonad-wallpaper-prof xscreensaver feh nitrogen w3m neofetch dzen2
