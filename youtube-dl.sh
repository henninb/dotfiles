...
fun_download() {
  if [ ! -f "media/$2" ]; then
    ...
    base=$(basename "media/$2" .opus)
    ffmpeg -i "media/$2" "media/${base}.mp3"
  else
...
fun_download 'https://www.youtube.com/watch?v=fp6AEbMqh18' push_matchbox_twenty.opus
...
echo ffmpeg -i Helene_Fischer_Atemlos_durch_die_Nacht.opus Helene_Fischer_Atemlos_durch_die_Nacht.mp3
