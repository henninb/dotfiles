...
if [ "$OS" = "FreeBSD" ]; then
  pkgs="trayer volumeicon feh xscreensaver numlockx blueman-applet copyq picom dunst flameshot nm conky syncthing mpd keepassxc"
else
  pkgs="trayer volumeicon feh xscreensaver numlockx blueman-applet copyq picom dunst flameshot nm-applet conky syncthing mpd keepassxc"
fi
