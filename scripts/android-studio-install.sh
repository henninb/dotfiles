...
wget "https://r2---sn-jxou0gtapo3-hn2e.gvt1.com/edgedl/android/studio/ide-zips/2023.1.1.27/android-studio-2023.1.1.27-linux.tar.gz" -O "$HOME/tmp/android-studio-linux.tar.gz"
echo "https://r2---sn-jxou0gtapo3-hn2e.gvt1.com/edgedl/android/studio/ide-zips/2003.1.1.27/android-studio-2003.1.1.27-linux.tar.gz"
