...
GENTOO_PKGS="meld handbrake vlc blender handbrake thunar games-emulation/dolphin seahorse xterm audacity gimp inkscape kdenlive mpv media-video/obs-studio app-admin/keepassxc peazip"
